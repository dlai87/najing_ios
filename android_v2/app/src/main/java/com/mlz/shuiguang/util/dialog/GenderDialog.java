...
public class GenderDialog {
    ...
    public GenderDialog(Context context) {
        ...
        view = inflater.inflate(R.layout.widget_dialog_gender, null);
        assignViews();
    }
    ...
    private void assignViews(){
        ...
        radiogroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if(checkedId==radio1.getId()) {
                    selectGender = radio1.getText().toString();
                }
                if(checkedId==radio2.getId()) {
                    selectGender = radio2.getText().toString();
                }
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (selectGender !=null && !selectGender.equals("")){
