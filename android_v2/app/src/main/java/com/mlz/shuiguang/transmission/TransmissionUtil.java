...
import com.mlz.shuiguang.transmission.AWSTask.DetectionTask;
import com.mlz.shuiguang.transmission.AWSTask.USERTask;
...
public class TransmissionUtil {
    ...
    public static void syncDetection(Context mContext){
        ...
        */
        ...
        DetectionTask detectionTask = new DetectionTask(mContext);
        HashMap params = new HashMap();
        // push
        params.put(SyncTask.PARAM_TASK, DetectionsHistoryTask.TASK_PUSH);
        detectionTask.sync(params);
        // pull
    }
    ...
    public static void syncUserInfo(Context mContext){
      ...
      //  }
        ...
        USERTask userTask = new USERTask(mContext);
        HashMap params = new HashMap();
        params.put(SyncTask.PARAM_TASK, DetectionsHistoryTask.TASK_PUSH);
