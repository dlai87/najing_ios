...
public class DBAdapter extends SQLiteOpenHelper {
    ...
    private void modifyTableUser(SQLiteDatabase db){
        String SPEC_1 = "ALTER TABLE "
                + DBGlobal.TABLE_USER + " ADD COLUMN " +
                DBGlobal.COL_WECHAT + " TEXT;";

        String SPEC_2 = "ALTER TABLE "
                + DBGlobal.TABLE_USER + " ADD COLUMN " +
                DBGlobal.COL_GOOGLE + " TEXT;";

        String SPEC_3 = "ALTER TABLE "
                + DBGlobal.TABLE_USER + " ADD COLUMN " +
                DBGlobal.COL_FACEBOOK + " TEXT;";
