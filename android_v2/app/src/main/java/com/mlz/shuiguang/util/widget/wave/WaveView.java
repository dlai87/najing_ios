package com.mlz.shuiguang.util.widget.wave;
...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.parseColor("#28d8e9ff");
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.parseColor("#3Cd8e9ff");
