...
public class UserFragment extends BaseFragment {
    ...
    private void assignViews(){
        ...
        passwordButton = (Button)view.findViewById(R.id.editPasswordButton);
    ...
    private void refreshViews(){
        ...
        emailLayout.setBackgroundColor(theme.getMinorColor(mContext));
        phoneLayout.setBackgroundColor(theme.getMinorColor(mContext));
        passwordLayout.setBackgroundColor(theme.getMinorColor(mContext));
        dobLayout.setBackgroundColor(theme.getMinorColor(mContext));
        genderLayout.setBackgroundColor(theme.getMinorColor(mContext));
        skinLayout.setBackgroundColor(theme.getMinorColor(mContext));



        if (mainAppHandler!=null) mainAppHandler.refreshTabBar();
